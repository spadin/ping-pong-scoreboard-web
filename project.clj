(defproject scoreboard-web "0.1.0-SNAPSHOT"
  ...
  :url "https://github.com/spadin/ping-pong-scoreboard-web"
  ...
  :cljsbuild ~(let [run-specs ["bin/specljs"  "resources/public/javascript/scoreboard-web_dev.js"]]
          {:builds {:dev {:source-paths ["src/cljs" "spec/cljs"]
                               :compiler {:output-to "resources/public/javascript/scoreboard-web_dev.js"
                                          :optimizations :whitespace
                                          :pretty-print true}
                          :notify-command run-specs}
                     :prod {:source-paths ["src/cljs"]
                             :compiler {:output-to "resources/public/javascript/scoreboard-web.js"
                                        :optimizations :simple}}}
            :test-commands {"test" run-specs}})

  :source-paths ["src/clj" "src/cljs"]
  :test-paths ["spec/clj"]
  :ring {:handler scoreboard-web.main/app})
